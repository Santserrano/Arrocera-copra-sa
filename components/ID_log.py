...
general_bloque = CTkButton(master=app, fg_color="#003b48", width=250, height=270, corner_radius=0, border_color="#003b48", border_width=5, hover_color="#006278", text="Secado\n de arroz", text_color="#fff", font=("Poppins Bold", 20), image=logistics_img, compound="top")
...
produccion_bloque = CTkButton(master=app, fg_color="#003b48", width=250, height=270, corner_radius=0, border_color="#003b48", border_width=5, hover_color="#006278", text="Carga y descarga\n de camiones", text_color="#fff", font=("Poppins Bold", 20), image=gerente_img, compound="top")
...
transporte_bloque = CTkButton(master=app, fg_color="#003b48", width=250, height=270, corner_radius=0, border_color="#003b48", border_width=5, hover_color="#006278", text="Almacenamiento\n de arroz", text_color="#fff", font=("Poppins Bold", 20), image=transporte_img, compound="top")
