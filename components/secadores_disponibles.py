...
def secadores_disponibles():
    ...
    frame_inferior.pack(expand=True, pady=(0, 80), side="top")
    ...
    # Contenido de la tarjeta
    # Título
    silo_label2 = CTkLabel(master=tarjeta_2, text="Silo 2", font=("Poppins Medium", 18), text_color="#171717")
    ...
    # Toneladas
    toneladas_label2 = CTkLabel(master=tarjeta_2, text="Capacidad: 60 toneladas", font=("Poppins Light", 13), text_color="#171717")
    toneladas_label2.grid(row=1, column=0, padx=(20, 0), pady=(0, 0), sticky="w")
    toneladas_valor2 = CTkLabel(master=tarjeta_2, text="Próxima limpieza: 3 días", font=("Poppins Bold", 14), text_color="#ff3b3b")
    toneladas_valor2.grid(row=2, column=0, padx=(20, 0), pady=(0, 0), sticky="w")

    estado_label2 = CTkLabel(master=tarjeta_2, text="Limpiar", font=("Poppins Medium", 14), fg_color="#003b48", corner_radius=25, width=74, height=25, text_color="#fff")
    estado_label2.grid(row=3, column=0, padx=(20, 0), pady=(5, 0), sticky="w")
    ...
    # Contenido de la tarjeta
    # Título
    silo_label3 = CTkLabel(master=tarjeta_3, text="Silo 3", font=("Poppins Medium", 18), text_color="#171717")
    ...
    # Toneladas
    toneladas_label3 = CTkLabel(master=tarjeta_3, text="Capacidad: 70 toneladas", font=("Poppins Light", 13), text_color="#171717")
    toneladas_label3.grid(row=1, column=0, padx=(20, 0), pady=(0, 0), sticky="w")
    toneladas_valor3 = CTkLabel(master=tarjeta_3, text="Próxima limpieza: 7 días", font=("Poppins Bold", 14), text_color="#ff3b3b")
    toneladas_valor3.grid(row=2, column=0, padx=(20, 0), pady=(0, 0), sticky="w")

    estado_label3 = CTkLabel(master=tarjeta_3, text="Limpiar", font=("Poppins Medium", 14), fg_color="#003b48", corner_radius=25, width=74, height=25, text_color="#fff")
    estado_label3.grid(row=3, column=0, padx=(20, 0), pady=(5, 0), sticky="w")
